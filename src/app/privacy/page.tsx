export default function Page() {
    return (
        <>
            <div className="flex items-center flex-col px-10">
                <div className="">
                    <p className="font-medium text-lg mt-24 mb-12 w-full border-l-4 pl-4 border-black">개인정보처리방침</p>
                    <p className="font-medium text-sm mb-24">
                    미소티켓은 (이하 &apos;회사&apos;는) 고객님의 개인정보를 중요시하며, &quot;정보통신망 이용촉진 및 정보보호&quot;에 관한 법률을 준수하고 있습니다.<br/>
    ...
    ο 본 방침은 : 2007 년 10 월 01 일 부터 시행됩니다.<br/><br/>

    ■ 수집하는 개인정보 항목<br/>
    회사는 회원가입, 상담, 서비스 신청 등등을 위해 아래와 같은 개인정보를 수집하고 있습니다.<br/>
    수집항목 : 이름 , 생년월일 , 성별 , 로그인ID , 비밀번호 , 비밀번호 질문과 답변, 자택 전화번호 , 자택 주소 , 휴대전화번호 , 이메일 , 주민등록번호 , 쿠키 , 결제기록<br/>
    개인정보 수집방법 : 홈페이지(회원가입)<br/><br/>
    ■ 개인정보의 수집 및 이용목적<br/>
    회사는 수집한 개인정보를 다음의 목적을 위해 활용합니다.<br/><br/>

    서비스 제공에 관한 계약 이행 및 서비스 제공에 따른 요금정산<br/><br/>
    ...
    회사는 귀하의 정보를 수시로 저장하고 찾아내는 &apos;쿠키(cookie)&apos; 등을 운용합니다. 쿠키란 웹사이트를 운영하는데 이용되는 서버가 귀하의 브라우저에 보내는 아주 작은 텍스트 파일로서 귀하의 컴퓨터 하드디스크에 저장됩니다.<br/><br/>
