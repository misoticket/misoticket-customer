        ...
        <>
            {
                isMobile ?
                    <div>
                        ...
                        <div className="mt-36">
                            <p className="w-full font-semibold text-2xl h-8 px-4">{ getCategoryName() }</p>
                            <div className="flex gap-6 mt-5 px-4 py-4 overflow-scroll scrollbar-hide">
                                {
                                    subCategoryList.map((subCategory) => (
                                        ...
                                        >
                                            <p 
                                                className={`font-medium whitespace-nowrap text-sm ${selectedSubCategory && subCategory.id === selectedSubCategory.id ? "text-theme-sub" : "text-black"}`}
                                            >
                                                {subCategory.name}
                                            </p>
                                            <Image src={rightArrowImg} width={6} height={6} alt="" />
                                        </div>
                                    ))
                                }
                            </div>
