    ...
    return (
        <>
            ...
            <div className="flex flex-col items-center py-4">
                <p className="my-4 font-semibold text-xl">상품권 시세</p>
                <div className="flex flex-col">
                    ...
                    <p className="text-center my-4 font-medium text-theme text-xs">※ 구겨지거나 선물용으로 부적합한 상품권은 매입가가 변경될수 있습니다. (구권포함)</p>
                    <div className="flex w-full mt-10 border-t border-solid border-gray-200">
                        <div className="h-14 w-full bg-gray-100 flex flex-col justify-center border-l border-r border-solid border-gray-200">
                            <p className="font-semibold text-sm text-center">상품권</p>
                        </div>
                        <div className="h-14 w-56 bg-gray-100 flex flex-col justify-center border-r border-solid border-gray-200">
                    ...
                    <div>
                        { 
                            showProductList.map((product) => (
                                ...
                                >
                                    <div className="h-14 w-full flex flex-col justify-center border-l border-r border-solid border-gray-200 group-hover:bg-gray-50">
                                        <p className="font-medium text-sm mx-5">{ product.name }</p>
                                    </div>
                                    <div className="h-14 w-56 border-r border-solid border-gray-200 flex flex-col justify-center items-center group-hover:bg-gray-50">
                                        ...
                                        <p className="font-medium text-xs text-center text-gray-400 mr-2">{ getCustomerSaleRatio(product) }%</p>
                                    </div>
                                    <div className="h-14 w-56 border-r border-solid border-gray-200 flex flex-col justify-center items-center group-hover:bg-gray-50">
                                        <p className="font-bold text-sm text-center">{ product.price.toLocaleString() }<span className="font-medium">원</span></p>
                                        <p className="font-medium text-xs text-center text-gray-400 mr-2">{ getSellerSaleRatio(product) }%</p>
                                    </div>
                                </div>
                            ))
                        }
